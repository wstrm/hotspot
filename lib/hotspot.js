...
var cjdnsFactory = function cjdnsFactory(config) {
  this.confPath = path.join(__dirname, '../.', config);
  this.cjdns = new CJDNS(JSON.parse(fs.readFileSync(this.confPath)));
};

cjdnsFactory.prototype.getNode = function getNode(ipaddr, callback) {
  var nodes = [];
  var cjdns = this.cjdns;
...
exports.cjdnsFactory = cjdnsFactory;
